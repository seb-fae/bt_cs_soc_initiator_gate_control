...
#define SL_CATALOG_BLE_PEER_MANAGER_CENTRAL_PRESENT
#define SL_CATALOG_BLE_PEER_MANAGER_COMMON_PRESENT
#define SL_CATALOG_BLE_PEER_MANAGER_FILTER_PRESENT
#define SL_CATALOG_BLUETOOTH_CONFIGURATION_PRESENT
#define SL_CATALOG_BLUETOOTH_CONTROLLER_ANCHOR_SELECTION_PRESENT
...
#define SL_CATALOG_CS_INITIATOR_PRESENT
#define SL_CATALOG_CS_INITIATOR_CLIENT_PRESENT
...
#define SL_CATALOG_RAIL_UTIL_BLE_CS_PRESENT
